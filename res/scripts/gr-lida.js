...
// FIN Imágenes Caratula --
	...
	// [dos]
		...
		m_array["Dbx_dos_version"]           = AnalyzeTagName(texto, "<Dbx_dos_version>([^\"<>]*)</Dbx_dos_version>", "");
	// [ipx]
		m_array["Dbx_ipx_ipx"]               = AnalyzeTagName(texto, "<Dbx_ipx_ipx>([^\"<>]*)</Dbx_ipx_ipx>", "");
		m_array["Dbx_ipx_type"]              = AnalyzeTagName(texto, "<Dbx_ipx_type>([^\"<>]*)</Dbx_ipx_type>", "");
		m_array["Dbx_ipx_port"]              = AnalyzeTagName(texto, "<Dbx_ipx_port>([^\"<>]*)</Dbx_ipx_port>", "");
