...
void frmImportarJuego::on_btnOk()
{
	...
	if(DatosJuego["thumbs"]=="null" || DatosJuego["thumbs"]=="")
	{
		...
		ImportPathNew->ui.txtPath_Datos_1->setText("");
		ImportPathNew->ui.txtPath_Datos_1->setEnabled(false);
		ImportPathNew->ui.btnDirPath_Datos_1->setEnabled(false);
	} else {
		img_thumbs = DatosJuego["thumbs"];

		DatosJuego["thumbs"] = stHomeDir +"thumbs/thumbs_" + img_thumbs;
		ImportPathNew->ui.txtPath_Datos_1->setText( DatosJuego["thumbs"] );
		ImportPathNew->ui.txtPath_Datos_1->setEnabled(true) ;
		ImportPathNew->ui.btnDirPath_Datos_1->setEnabled(true);
	}
	...
	if(DatosJuego["cover_front"]=="null" || DatosJuego["cover_front"]=="")
	{
		...
		ImportPathNew->ui.txtPath_Datos_2->setText("");
		ImportPathNew->ui.txtPath_Datos_2->setEnabled(false);
		ImportPathNew->ui.btnDirPath_Datos_2->setEnabled(false);
	} else {
		...
		ImportPathNew->ui.txtPath_Datos_2->setText( DatosJuego["cover_front"] );
		ImportPathNew->ui.txtPath_Datos_2->setEnabled(true);
		ImportPathNew->ui.btnDirPath_Datos_2->setEnabled(true);
	}
	...
	if(DatosJuego["cover_back"]=="null" || DatosJuego["cover_back"]=="")
	{
		...
		ImportPathNew->ui.txtPath_Datos_3->setText("");
		ImportPathNew->ui.txtPath_Datos_3->setEnabled(false);
		ImportPathNew->ui.btnDirPath_Datos_3->setEnabled(false);
	} else {
		...
		ImportPathNew->ui.txtPath_Datos_3->setText( DatosJuego["cover_back"] );
		ImportPathNew->ui.txtPath_Datos_3->setEnabled(true) ;
		ImportPathNew->ui.btnDirPath_Datos_3->setEnabled(true);
	}
	...
	if( indx_fin_descarga == 1 )
	{
		...
		while(!child.isNull())
		{
			...
			else if(child.tagName() == "scummvm")
			{
				...
				DatosScummvm["cdrom"]         = child.firstChildElement("cdrom").text()				; // cdrom ui.cbxSvm_6->currentIndex()
